...
export interface UseEditableSurfaceReturn {
...
export function useEditableSurface(o: UseEditableSurfaceOptions): UseEditableSurfaceReturn {
...
function makeSubmit(s: { current: { doc: ComposerDoc } }, onSubmit?: UseEditableSurfaceOptions['onSubmit']) {
